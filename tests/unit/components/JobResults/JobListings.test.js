...
describe('JobListings', () => {
  ...
  describe('when component mounts', () => {
    it('makes call to fetch jobs from api', () => {
      ...
      usePreviousAndNextPages({ previousPage: 1, nextPage: 3 })
  ...
  it('creates a job listing for a maximum of 10 jobs', async () => {
    ...
    usePreviousAndNextPages({ previousPage: undefined, nextPage: 2 })
  ...
  it('displays page number', () => {
    ...
    usePreviousAndNextPages({ previousPage: 4, nextPage: 6 })
    const wrapper = shallowMount(JobListings, createConfig())
    expect(wrapper.text()).toMatch('Page 5')
  })

  describe('when the user is on firt page of job rsults', () => {
  ...
  describe('when the user is on last page of job rsults', () => {
    it('does not show link to next page', async () => {
      ...
      usePreviousAndNextPages({ previousPage: 1, nextPage: undefined })
